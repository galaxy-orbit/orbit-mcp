...
exports.ReleasesPage = exports.NamespacesPage = exports.SkillsPage = exports.SmitheryPage = exports.PagePromise = exports.AbstractPage = void 0;
...
class AbstractPage {
    ...
    async getNextPage() {
        ...
        if (!nextOptions) {
            throw new error_1.SmitheryError('No next page expected; please check `.hasNextPage()` before calling `.getNextPage()`.');
        }
...
class SmitheryPage extends AbstractPage {
    constructor(client, response, body, options) {
...
exports.SmitheryPage = SmitheryPage;
...
class NamespacesPage extends AbstractPage {
    constructor(client, response, body, options) {
        super(client, response, body, options);
...
exports.NamespacesPage = NamespacesPage;
class ReleasesPage extends AbstractPage {
    constructor(client, response, body, options) {
        super(client, response, body, options);
