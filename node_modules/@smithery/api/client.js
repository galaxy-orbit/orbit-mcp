...
var _Smithery_instances, _a, _Smithery_encoder, _Smithery_baseURLOverridden;
Object.defineProperty(exports, "__esModule", { value: true });
exports.Smithery = void 0;
...
const skills_1 = require("./resources/skills.js");
const tokens_1 = require("./resources/tokens.js");
const connections_1 = require("./resources/connections/connections.js");
const namespaces_1 = require("./resources/namespaces/namespaces.js");
const organizations_1 = require("./resources/organizations/organizations.js");
const servers_1 = require("./resources/servers/servers.js");
...
class Smithery {
     ...
     */
    constructor({ baseURL = (0, env_1.readEnv)('SMITHERY_BASE_URL'), apiKey = (0, env_1.readEnv)('SMITHERY_API_KEY'), connectBaseURL = (0, env_1.readEnv)('SMITHERY_CONNECT_BASE_URL') ?? 'https://smithery.run', ...opts } = {}) {
        _Smithery_instances.add(this);
        _Smithery_encoder.set(this, void 0);
        this.health = new API.Health(this);
        /**
         * Browse the MCP server registry, manage server configuration, and handle deployments
         */
        this.servers = new API.Servers(this);
        /**
         * Discover and search reusable prompt-based skills for MCP servers
         */
        this.skills = new API.Skills(this);
        this.namespaces = new API.Namespaces(this);
        this.organizations = new API.Organizations(this);
        this.tokens = new API.Tokens(this);
        this.connections = new API.Connections(this);
        if (apiKey === undefined) {
            throw new Errors.SmitheryError("The SMITHERY_API_KEY environment variable is missing or empty; either provide it, or instantiate the Smithery client with an apiKey option, like new Smithery({ apiKey: 'My API Key' }).");
        }
        const options = {
            apiKey,
            connectBaseURL,
        ...
        this.logLevel =
            (0, log_1.parseLogLevel)(options.logLevel, 'ClientOptions.logLevel', this) ??
                (0, log_1.parseLogLevel)((0, env_1.readEnv)('SMITHERY_LOG'), "process.env['SMITHERY_LOG']", this) ??
                defaultLogLevel;
        this.fetchOptions = options.fetchOptions;
        this.maxRetries = options.maxRetries ?? 2;
        this.fetch = options.fetch ?? Shims.getDefaultFetch();
        tslib_1.__classPrivateFieldSet(this, _Smithery_encoder, Opts.FallbackEncoder, "f");
        const customHeadersEnv = (0, env_1.readEnv)('SMITHERY_CUSTOM_HEADERS');
        if (customHeadersEnv) {
            const parsed = {};
    ...
    buildURL(path, query, defaultBaseURL) {
        const resolvedDefaultBaseURL = defaultBaseURL === 'https://smithery.run' ? this.connectBaseURL || defaultBaseURL : defaultBaseURL;
        const baseURL = (defaultBaseURL === 'https://smithery.run' && resolvedDefaultBaseURL) ||
            (!tslib_1.__classPrivateFieldGet(this, _Smithery_instances, "m", _Smithery_baseURLOverridden).call(this) && resolvedDefaultBaseURL) ||
            this.baseURL;
    ...
    buildBody({ options }) {
        ...
        if (!body) {
            ...
            if (body == null && 'body' in options) {
                return tslib_1.__classPrivateFieldGet(this, _Smithery_encoder, "f").call(this, { body, headers: (0, headers_1.buildHeaders)([rawHeaders]) });
            }
        ...
        ArrayBuffer.isView(body) ||
            ...
            return tslib_1.__classPrivateFieldGet(this, _Smithery_encoder, "f").call(this, { body, headers });
        }
    }
}
exports.Smithery = Smithery;
_a = Smithery, _Smithery_encoder = new WeakMap(), _Smithery_instances = new WeakSet(), _Smithery_baseURLOverridden = function _Smithery_baseURLOverridden() {
    return this.baseURL !== 'https://api.smithery.ai';
};
Smithery.Smithery = _a;
Smithery.DEFAULT_TIMEOUT = 60000; // 1 minute
Smithery.SmitheryError = Errors.SmitheryError;
Smithery.APIError = Errors.APIError;
Smithery.APIConnectionError = Errors.APIConnectionError;
Smithery.APIConnectionTimeoutError = Errors.APIConnectionTimeoutError;
Smithery.APIUserAbortError = Errors.APIUserAbortError;
Smithery.NotFoundError = Errors.NotFoundError;
Smithery.ConflictError = Errors.ConflictError;
Smithery.RateLimitError = Errors.RateLimitError;
Smithery.BadRequestError = Errors.BadRequestError;
Smithery.AuthenticationError = Errors.AuthenticationError;
Smithery.InternalServerError = Errors.InternalServerError;
Smithery.PermissionDeniedError = Errors.PermissionDeniedError;
Smithery.UnprocessableEntityError = Errors.UnprocessableEntityError;
Smithery.toFile = Uploads.toFile;
Smithery.Health = health_1.Health;
Smithery.Servers = servers_1.Servers;
Smithery.Skills = skills_1.Skills;
Smithery.Namespaces = namespaces_1.Namespaces;
Smithery.Organizations = organizations_1.Organizations;
Smithery.Tokens = tokens_1.Tokens;
Smithery.Connections = connections_1.Connections;
