...
import { DomainListResponse, DomainUpdateParams, DomainUpdateResponse, Domains } from "./domains.mjs";
import * as IconAPI from "./icon.mjs";
import { Icon, IconDeleteResponse, IconUploadResponse } from "./icon.mjs";
...
import { DeployPayload, ExternalDeployPayload, HostedDeployPayload, ReleaseDeployParams, ReleaseDeployResponse, ReleaseGetParams, ReleaseGetResponse, ReleaseListParams, ReleaseListResponse, ReleaseListResponsesReleasesPage, ReleaseResumeParams, ReleaseResumeResponse, ReleaseStreamParams, ReleaseStreamResponse, Releases, ServerCard } from "./releases.mjs";
...
export declare class Servers extends APIResource {
     ...
     * ```
     */
    transfer(qualifiedName: string, body: ServerTransferParams, options?: RequestOptions): APIPromise<ServerTransferResponse>;
}
...
export declare namespace Servers {
    ...
    export { Icon as Icon, type IconDeleteResponse as IconDeleteResponse, type IconUploadResponse as IconUploadResponse, };
    export { Domains as Domains, type DomainUpdateResponse as DomainUpdateResponse, type DomainListResponse as DomainListResponse, type DomainUpdateParams as DomainUpdateParams, };
}
